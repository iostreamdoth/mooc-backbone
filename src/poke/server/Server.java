...
public class Server {
	...
	private void init(File cfg) {
		...
		System.out.println("File at " + cfg.getAbsolutePath());
		BufferedInputStream br = null;
		System.out.println("----------Error before decode----------------");
		try {
			System.out.println("----------Error before new byte----------------");
			byte[] raw = new byte[(int) cfg.length()];
			System.out.println("----------Error before BufferedInput fuck----------------");
			br = new BufferedInputStream(new FileInputStream(cfg));
			System.out.println("----------Error before fuck read----------------");
			br.read(raw);
			
			System.out.println("Error before decode" + new String(raw));
			conf = JsonUtil.decode(new String(raw), ServerConf.class);
			System.out.println("Error After decode");
